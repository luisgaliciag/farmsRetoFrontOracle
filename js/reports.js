function generateReportStatus(){
    console.log("test")
    $.ajax({
        url: "http://143.47.234.84:8080/api/Reservation/report-status",
        type: 'GET',
...
function traerReporteDate(){
    ...
    $.ajax({
        url:"http://143.47.234.84:8080/api/Reservation/report-dates/"+fechaInicio+"/"+fechaCierre,
        type:"GET",
        datatype:"JSON",
        success:function(respuesta){
            console.log(respuesta);
...
function traerReporteClientes(){
    $.ajax({
        url:"http://143.47.234.84:8080/api/Reservation/report-clients",
        type:"GET",
        datatype:"JSON",
        success:function(respuesta){
            console.log(respuesta);
